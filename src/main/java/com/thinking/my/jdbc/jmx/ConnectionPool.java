...
import com.thinking.my.jdbc.PoolProperties;
import com.thinking.my.jdbc.PoolUtilities;
import com.thinking.my.jdbc.Validator;
...
public class ConnectionPool extends NotificationBroadcasterSupport
     ...
     * the connection pool
     */
    protected com.thinking.my.jdbc.ConnectionPool pool = null;
    /**
    ...
    public ConnectionPool(com.thinking.my.jdbc.ConnectionPool pool) {
        super();
        this.pool = pool;
    }

    public com.thinking.my.jdbc.ConnectionPool getPool() {
        return pool;
    }
